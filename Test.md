...
#### 1月14日
前田：発表資料の作成及び発表練習、レポート作成のバックアップ  
橋村：レポート作成  
森松：レポート作成  
太田：Botpress  
永岡：レポート作成  
...
#### 12月10日
1. アイデア出し（白：事実・出た案）
・教授とアポイントが取りやすい「LOOP予約管理アプリ」
・節約献立ボットや充電スタンドの管理システム
・店員の代わりに商品の場所を検索できるアプリ
・毎朝、その日の授業情報を通知するチャットボット
・学生向け割引を活用した旅行支援サービス（学割旅行）
・連絡の見落としを防ぐためのチャットボット
・特に、学校関連のテーマは実装や検証がしやすいという意見が多く挙がった。

2. ポジティブな意見・関心（赤：感情・直感）
・学校関連のアプリは取り組みやすそうだと感じた
・「今日の時間割」を通知する仕組みはシンプルで分かりやすく、好印象
・学割旅行はテーマとして考えやすく、興味を持った
・商品検索機能は便利で、利用価値が高そう
・実体験として、東京旅行時にホテル代が高く困ったことから、学割旅行案に共感が集まった

3. 発展・改善案（黄：可能性・アイデア拡張）
・既存案を発展させる形で、以下の改善案が挙げられた。
・学割旅行において、予算を入力すると自動で旅行プランを作成する仕組み
・空いている店舗を検索でき、混雑状況なども考慮したチャットボット
・就活向けに文章を敬語へ変換する「言葉チェンジ」機能
・関西弁、若者言葉、やさしい表現など、言葉のトーンを変換する仕組み

4. 課題・懸念点（黒：注意・問題点）

・旅行プランは料金だけでなく、移動距離などの要素も考慮する必要がある
・言葉チェンジ機能は、言葉の境界が曖昧で判定が難しい可能性がある
・授業通知アプリは利用者が限定される恐れがある
・商品検索は売り場変更や季節商品によって情報更新が大変
・単なるチャットボットとしての存在意義が薄くならないかという懸念

5. 追加アイデア（緑：創造・新視点）
・議論の中で、以下のような新たな視点も提案された。
・単語カードやスラング学習への応用
・多言語変換を組み込んだチャットボット
・商品検索において、店舗別・価格順・品質順などの条件での検索機能

6. まとめ

本ミーティングでは、学校生活・旅行・言語変換・商品検索を軸に、多様なチャットボット／アプリ案が共有された。
特に学割旅行や学校関連サービスは、実体験に基づいた課題意識が強く、今後の企画検討の中心テーマとして有望であると考えられる。
